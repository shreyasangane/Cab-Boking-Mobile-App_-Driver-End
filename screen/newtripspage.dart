...
class _NewTripPageState extends State<NewTripPage> {
  ...
  void getLocationUpdates(){
    ...
    print("Exiting getLocationUpdates");
  ...
  void updateTripDetails() async{
    ...
    if(!isRequestingDirection){
      ...
      var directionDetails = await HelperMethods.getDiretionDetails(positionLatLng, destinationLatLng);
  ...
  Future<void> getDirection(LatLng pickupLatLng, LatLng destinationLatLng) async {
    ...
    var thisDetails = await HelperMethods.getDiretionDetails(pickupLatLng, destinationLatLng);
  ...
  void endTrip() async {
    ...
    var directionDetails = await HelperMethods.getDiretionDetails(widget.tripDetails.pickup, currentLatLng);
